@extends('layouts.app')
@section('title', __('messages.create').' '.__('messages.menu.package') )
                ...
                <div class="m-portlet__head-caption">
                    <div class="m-portlet__head-title">
                        <h3 class="m-portlet__head-text">
                            {{ __('messages.create').' '.__('messages.menu.package') }}
                        </h3>
                    </div>
                </div>
            ...
            <div class="m-portlet__body">
                <form action="/packages" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-9">
                            <textarea class="form-control" name="description_ar" placeholder="{{ __('messages.description_ar') }}">{{ old('description_ar') }}</textarea>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-9">
                            <textarea class="form-control" name="description_en" placeholder="{{ __('messages.description_en') }}">{{ old('description_en') }}</textarea>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-9">
                            <input class="form-control" type="color" name="color" value="{{ old('color') }}" placeholder="{{ __('messages.color') }}" autocomplete="off" />
                            @if ($errors->has('color'))
                                <span class="invalid-feedback" role="alert">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-9">
                        <input class="form-control" type="number" name="amount" value="{{ old('amount') }}" placeholder="{{ __('messages.amount') }}" autocomplete="off" />
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-9">
                        <input class="form-control" type="number" name="duration" value="{{ old('duration') }}" placeholder="{{ __('messages.duration') }}" autocomplete="off" />
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-9">
                        <input class="form-control" type="number" name="discount_percentage" value="{{ old('discount_percentage') }}" placeholder="{{ __('messages.discount_percentage') }}" autocomplete="off" />
