@extends('layouts.app')
@section('title', __('messages.create').' '.__('messages.menu.salon') )
...
<div class="row">
    ...
    <div class="m-portlet m-portlet--full-height">
        ...
        <div class="m-portlet__head-caption">
          <div class="m-portlet__head-title">
            <h3 class="m-portlet__head-text">
              {{ __('messages.create').' '.__('messages.menu.salon') }}
            </h3>
          </div>
        </div>
      ...
      <div class="m-portlet__body">
        <form action="/salons" method="POST" enctype="multipart/form-data">
          ...
          <div class="form-group row">
            ...
            <div class="col-9">
              <input class="form-control" name="phone" value="{{ old('phone') }}" placeholder="{{ __('messages.phone') }}" autocomplete="off" />
              @if ($errors->has('phone'))
                <span class="invalid-feedback" role="alert">
          ...
          <div class="form-group row">
            ...
            <div class="col-9">
              <input class="form-control" name="phone_2" value="{{ old('phone_2') }}" placeholder="{{ __('messages.phone_2') }}" autocomplete="off" />
          ...
          <div class="form-group row">
            ...
            <div class="col-9">
              <input class="form-control" name="bank_name" value="{{ old('bank_name') }}" placeholder="{{ __('messages.bank_name') }}" autocomplete="off" />
          ...
          <div class="form-group row">
            ...
            <div class="col-9">
              <input class="form-control" name="bank_account_number" value="{{ old('bank_account_number') }}" placeholder="{{ __('messages.bank_account_number') }}" autocomplete="off" />
          ...
          <div class="form-group row">
            ...
            <div class="col-9">
              <input class="form-control" name="bank_name_2" value="{{ old('bank_name_2') }}" placeholder="{{ __('messages.bank_name_2') }}" autocomplete="off" />
          ...
          <div class="form-group row">
            ...
            <div class="col-9">
              <input class="form-control" name="bank_account_number_2" value="{{ old('bank_account_number_2') }}" placeholder="{{ __('messages.bank_account_number_2') }}" autocomplete="off" />
          ...
          <div class="form-group row">
            ...
            <div class="col-9">
              <input class="form-control" name="tax_number" value="{{ old('tax_number') }}" placeholder="{{ __('messages.tax_number') }}" autocomplete="off" />
          ...
          <div class="form-group row">
            ...
            <div class="col-9">
              <input class="form-control" name="commercial_register" value="{{ old('commercial_register') }}" placeholder="{{ __('messages.commercial_register') }}" autocomplete="off" />
          ...
          <div class="form-group row">
            ...
            <div class="col-9">
              <input class="form-control" name="percentage" value="{{ old('percentage') }}" placeholder="{{ __('messages.percentage') }}" autocomplete="off" />
          ...
          <div class="form-group row">
            ...
            <div class="col-9">
              <input class="form-control" name="deposit_percentage" value="{{ old('deposit_percentage') }}" placeholder="{{ __('messages.deposit_percentage') }}" autocomplete="off" />
